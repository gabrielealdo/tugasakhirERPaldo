        ...
        <div class="container">
                ...
                <div class="card bg-secondary shadow border-0">
                    <div class="card-header bg-transparent pb-5">
					 ...
					 <form role="form" method="POST" action="<?php echo e(route('storeProduct')); ?>">
					 	<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gabrielle Aldo\Downloads\erp coba\hospital-inventory-erp\testsite\resources\views/productform.blade.php ENDPATH**/ ?>