                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        ...
                        <form role="form" method="POST" action="<?php echo e(route('register')); ?>">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                      <input type="text" id="captcha" class="form-control<?php echo e($errors->has('captcha') ? ' is-invalid' : ''); ?>" placeholder="Enter Captcha" name ="captcha" required>
                                ...
                                <button type="button" class="btn btn-dark btn-refresh">Refresh</button>
                            </div>
                            </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'bg-default'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Gabrielle Aldo\Downloads\erp coba\hospital-inventory-erp\testsite\resources\views/auth/register.blade.php ENDPATH**/ ?>