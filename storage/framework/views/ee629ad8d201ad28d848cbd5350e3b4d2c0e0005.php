    ...
    <div class="container px-4">
        <a class="navbar-brand" href="<?php echo e(route('home')); ?>">
            <div class="col-lg-5 col-md-6">
                      <h2><i class="ni ni-fat-add text-light"></i> <?php echo e(__('Hospital ERP')); ?>
...
</nav><?php /**PATH C:\Users\Gabrielle Aldo\Downloads\erp coba\hospital-inventory-erp\testsite\resources\views/layouts/navbars/navs/guest.blade.php ENDPATH**/ ?>